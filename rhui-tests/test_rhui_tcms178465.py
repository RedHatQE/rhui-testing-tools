...
class test_tcms_178465(RHUITestcase):
    ...
    def _test(self):
        ...
        RHUIManagerCds.unassociate_repo_cds(self.rs.RHUA[0], "Cluster1", ["repo1"])
        ...
        rhui_cdses = RHUIManagerCds.info(self.rs.RHUA[0], ["Cluster1"])
    ...
    def _cleanup(self):
        ...
        RHUIManagerRepo.delete_repo(self.rs.RHUA[0], ["repo1", "repo2"])
