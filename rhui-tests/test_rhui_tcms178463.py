...
class test_tcms_178463(RHUITestcase):
    ...
    def _setup(self):
        ...
        RHUIManagerCds.add_cds(self.rs.Instances["RHUA"][0], self.cluster, self.rs.Instances["CDS"][0].private_hostname)
    ...
    def _cleanup(self):
        ...
        RHUIManagerCds.delete_cds(self.rs.Instances["RHUA"][0], self.cluster,
