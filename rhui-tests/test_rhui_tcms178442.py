...
class test_tcms_178442(RHUITestcase, RHUI_has_three_CDSes):
    def _setup(self):
        ...
        RHUIManagerCds.add_cds(self.rs.Instances["RHUA"][0], "Cluster1", self.rs.Instances["CDS"][2].private_hostname)
    ...
    def _cleanup(self):
        ...
        RHUIManagerCds.delete_cds(self.rs.Instances["RHUA"][0], "Cluster2", [self.rs.Instances["CDS"][2].private_hostname])
