...
class test_tcms_178440(RHUITestcase, RHUI_has_two_CDSes):
    ...
    def _test(self):
        ...
        '''[TCMS#178440 test] Check pulp-admin and rhui cluster info are the same'''
    ...
    def _cleanup(self):
        '''[TCMS#178440 cleanup] Remove a cds'''
