...
class test_tcms_178478(RHUITestcase, RHUI_has_RH_cert, RHUI_has_two_CLIs_RHEL6, RHUI_has_two_CDSes):
    def _setup(self):
        ...
        RHUIManagerCds.associate_repo_cds(self.rs.Instances["RHUA"][0], "Cluster2", ["Red Hat Update Infrastructure 2 \(RPMs\) \(6Server-x86_64\)"])
        ...
        RHUIManagerClient.generate_ent_cert(self.rs.Instances["RHUA"][0], "Cluster1", ["Red Hat Update Infrastructure 2 \(RPMs\)"], "cert1", "/root/", validity_days="", cert_pw=None)
        RHUIManagerClient.generate_ent_cert(self.rs.Instances["RHUA"][0], "Cluster2", ["Red Hat Update Infrastructure 2 \(RPMs\)"], "cert2", "/root/", validity_days="", cert_pw=None)
