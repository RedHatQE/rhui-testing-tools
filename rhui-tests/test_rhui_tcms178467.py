...
class test_tcms_178467(RHUITestcase, RHUI_has_RH_cert):
    ...
    def _test(self):
        ...
        Expect.ping_pong(self.rs.Instances["CDS"][0], "test -f /var/lib/pulp-cds/repos/repo1/custom-signed-rpm-1-0.1.fc17.noarch.rpm && echo SUCCESS", "[^ ]SUCCESS")
        Expect.ping_pong(self.rs.Instances["CDS"][0], "find /var/lib/pulp-cds/ -name 'mongodb*.rpm' | grep mongodb && echo SUCCESS", "[^ ]SUCCESS")
