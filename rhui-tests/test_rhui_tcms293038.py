...
class test_tcms_290038(RHUITestcase, RHUI_has_two_CDSes):
    def _setup(self):
        '''[TCMS#290038 setup] Do initial rhui-manager run'''
        RHUIManager.initial_run(self.rs.Instances["RHUA"][0])

        '''[TCMS#290038 setup] Add cds'''
        RHUIManagerCds.add_cds(self.rs.Instances["RHUA"][0], "Cluster1", self.rs.Instances["CDS"][0].private_hostname)

    def _test(self):
        '''[TCMS#290038 test] Check CDS info screen'''
        rhui_cds = RhuiCds(
        ...
        '''[TCMS#290038 test] Check pulp-admin and rhui cluster info are the same'''
    ...
    def _cleanup(self):
        '''[TCMS#290038 cleanup] Remove cds'''
