...
class test_tcms_191046(object):
    def __init__(self):
        argparser = argparse.ArgumentParser(description='RHUI TCMS testcase test-rhui-191046')
    ...
    def test_04_add_custom_repos(self):
        ...
        RHUIManagerRepo.add_custom_repo(self.rs.RHUA, "repo1", custom_gpg="/root/public.key")
